...
import MovimentacaoForm from "../components/MovimentacaoForm"; // Certifique-se de ajustar o caminho do seu formulário
        ...
        <main className="min-h-screen bg-zinc-50 font-sans antialiased">
            ...
            <nav className="w-full max-w-4xl mx-auto px-4 pt-12">
                ...
                >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Voltar para movimentações</span>
                </Link>
            </nav>
            ...
            <section className="pb-20">
                ...
                <div className="max-w-4xl mx-auto px-4 py-6">
                    <div className="space-y-1 border-l-4 border-blue-600 pl-6">
                        <h1 className="text-3xl font-black text-zinc-900 uppercase italic tracking-tighter">
                            Nova <span className="text-blue-600">Movimentação</span>
                        </h1>
                        <p className="text-zinc-400 text-[10px] font-bold uppercase tracking-[0.2em]">
                            Lançamento e auditoria de fluxos de estoque
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-4 mt-8 flex items-center justify-between text-zinc-400 border-t border-zinc-200 pt-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Módulo de Inventário Ativo</span>
                    </div>
                    <div className="flex items-center gap-4">
                         <span className="text-[9px] font-medium italic opacity-50 text-zinc-600">Stock Flow Management v1.2</span>
                    </div>
                </div>
            </section>
        </main>

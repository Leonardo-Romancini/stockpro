        ...
        <main className="min-h-screen bg-zinc-50 font-sans antialiased">
            ...
            <nav className="w-full max-w-4xl mx-auto px-4 pt-12">
                ...
                >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Voltar para a listagem</span>
                </Link>
            </nav>
            ...
            <section className="pb-20">
                ...
                <div className="max-w-4xl mx-auto px-4 mt-8 flex items-center justify-between text-zinc-400 border-t border-zinc-200 pt-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest">Campos Obrigatórios</span>
                    </div>
                    <span className="text-[9px] font-medium italic">StockPro Security Protocol v3.0</span>
                </div>
            </section>
        </main>
    );
